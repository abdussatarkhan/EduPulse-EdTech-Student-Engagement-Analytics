...
# 📊 EduPulse: Higher-Ed & Online Learning Student Mastery Analytics

**Higher-Ed & Online Learning Platform Analytics Data Warehouse: Course completion funnels, video engagement drop-off heatmaps, quiz failure correlation, and student mastery paths.**

[![CI Analytics Pipeline](https://github.com/abdussatarkhan/EduPulse-EdTech-Student-Engagement-Analytics/actions/workflows/ci.yml/badge.svg)](https://github.com/abdussatarkhan/EduPulse-EdTech-Student-Engagement-Analytics/actions)
...
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-brightgreen.svg?style=flat-square)](https://github.com/abdussatarkhan/EduPulse-EdTech-Student-Engagement-Analytics)
...
**EduPulse-EdTech-Student-Engagement-Analytics** is an enterprise-grade analytics data warehouse and business intelligence platform built for **EdTech & Learning Analytics**.
...
### 1️⃣ Executive KPI Command Center (Vibrant Campus White & Indigo (Light))
...
```
                    ...
                    └────────────┬────────────┘
                                 ...
                                 ▼
┌──────────────────────┐   ┌─────────────────────────┐   ┌─────────────────────────┐
│     dim_students     │──►│     fact_course_enrollments │◄──┤     dim_courses      │
└──────────────────────┘   └─────────────┬───────────┘   └─────────────────────────┘
                                         │
       ┌─────────────────────────────────┼─────────────────────────────────┐
       ▼                                 ▼                                 ▼
┌──────────────────────┐   ┌─────────────────────────┐   ┌─────────────────────────┐
│     dim_modules      │   │     dim_instructors     │   │     dim_date         │
└──────────────────────┘   └─────────────────────────┘   └─────────────────────────┘
```
...
FROM edupulse_dw.fact_course_enrollments f
JOIN edupulse_dw.dim_date dt ON f.date_key = dt.date_key
...
```bash
git clone https://github.com/abdussatarkhan/EduPulse-EdTech-Student-Engagement-Analytics.git
cd EduPulse-EdTech-Student-Engagement-Analytics
