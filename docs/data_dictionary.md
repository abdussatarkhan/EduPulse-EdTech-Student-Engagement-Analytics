...
## 🏢 Platform: EduPulse: Higher-Ed & Online Learning Student Mastery Analytics
**Schema**: `edupulse_dw`  
...
### 2. `dim_students`
Dimensional attribute master for Students.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `students_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `students_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
...
### 2. `dim_courses`
Dimensional attribute master for Courses.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `courses_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `courses_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### 2. `dim_modules`
Dimensional attribute master for Modules.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `modules_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `modules_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### 2. `dim_instructors`
Dimensional attribute master for Instructors.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `instructors_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `instructors_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
Transactional and snapshot grain telemetry table tracking Course Enrollments.
...
Transactional and snapshot grain telemetry table tracking Video Interactions.
...
### `fact_quiz_assessments`
Transactional and snapshot grain telemetry table tracking Quiz Assessments.
...
### `fact_certification_awards`
Transactional and snapshot grain telemetry table tracking Certification Awards.
